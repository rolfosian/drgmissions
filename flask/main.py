...
# Also it *might* absolutely blow a gasket on mission rollover so have kill_all_python_processes.py ready to kill the spawned processes (it will constantly kill and make new ones) if you really want to run this debug mode on wangblows. im not going ot bother debugging it honestly
