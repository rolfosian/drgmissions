...
function Main()
    ...
    if missions then
        ...
        master['timestamp'] = currentDateTime
        -- local dailyspecial = GetDailyDrink() -- IRRELEVANT, DAILY SPECIAL IS COMPLETELY RANDOM - WIKI IS WRONG
        -- master['Daily Special'] = dailyspecial
        ...
        local options = {
            indent = "  ",
            keyorder = {"timestamp", "Daily Special", "Deep Dives", "Biomes"}
          }
